 ...
 * 
 * Extrae los coches del perfil de Wallapop de Elite Motors
...
const WALLAPOP_PROFILE_URL = 'https://es.wallapop.com/user/qjwy93w0qezo';
...
// Función principal
async function main() {
    console.log('🚗 Elite Motors - Importador Wallapop');
    console.log('================================================\n');
