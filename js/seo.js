...
function injectLocalBusinessSchema() {
    ...
    const schema = {
        ...
        "url": "https://webcochesegundamano.github.io/elite-motors//",
        "telephone": "+34910922098",
        "email": "elite-motors@gmail.com",
        "address": {
            "@type": "PostalAddress",
    ...
    if (carId && window.location.pathname.includes('coche.html')) {
        try {
            ...
            if (car) {
                ...
                document.title = `${car.brand} ${car.model} (${car.year}) | Elite Motors Madrid`;
