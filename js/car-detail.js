...
async function loadCarDetail(id) {
    ...
    try {
        ...
        if (whatsappBtn) {
            whatsappBtn.href = `https://wa.me/34910922098?text=Hola,%20estoy%20interesado%20en%20el%20${encodeURIComponent(car.brand + ' ' + car.model)}%20de%20Autos%20Sanchez%20Guerrero.`;
        }
            ...
            <div class="car-detail-sidebar">
                <div class="glass" style="padding: 2.5rem; border-color: rgba(255,255,255,0.05); position: sticky; top: 120px;">
                    ...
                    <div class="actions" style="display: flex; flex-direction: column; gap: 1rem;">
                        <a href="https://wa.me/34910922098?text=Hola,%20estoy%20interesado%20en%20el%20${encodeURIComponent(car.brand + ' ' + car.model)}" class="btn btn-whatsapp" style="width: 100%;">
